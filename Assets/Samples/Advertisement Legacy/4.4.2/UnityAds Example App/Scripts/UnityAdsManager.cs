...
{
#if UNITY_ANDROID
    public string GAME_ID = "5597982"; //replace with your gameID from dashboard. note: will be different for each platform. (ja esta com o do viridis)
#elif UNITY_IOS
    public string GAME_ID = "5597983"; 
#endif
